...
public class SharedPreference {
    ...
    public static final String SP_Driver_APP = "spCustomerApp";
    public static final String SP_ID = "spId";
    public static final String SP_NAMA = "spNama";
    public static final String SP_EMAIL = "spEmail";
    public static final String SP_LEVEL = "spLevel";
    public static final String SP_ID_DRIVER = "spIdDriver";
    ...
    public void deleteIdDriver(Context context,String keySP){
