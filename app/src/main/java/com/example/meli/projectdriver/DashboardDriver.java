...
public class DashboardDriver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView card2 = (CardView) findViewById(R.id.card_order1);
        CardView card3 = (CardView) findViewById(R.id.card_history1);
        CardView card4 = (CardView) findViewById(R.id.card_edit1);
        CardView card5 = (CardView) findViewById(R.id.card_logout1);
        TextView text = (TextView)  findViewById(R.id.namesz);
        priceDashboard3 = (TextView) findViewById(R.id.priceDashboard3);
        mContext = this;
        ...
        userCall.enqueue(new Callback<GetUser>() {
            ...
            public void onResponse(Call<GetUser> call, Response<GetUser>
                ...
                priceDashboard3.setText(formatRupiah.format(saldo));
                refresh();
            }
        ...
        card2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), RequestOrder.class);
        ...
        card4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), EditProfileDriver.class);
